...
describe('PluginAPI', function () {
  ...
  describe('properties', function () {
    ...
    it('should have "commandHistory"', function () {
  ...
  describe('validateConfig', function () {
    var errors = { errors: ['error1', 'error2'], depreciations: [] };
  ...
  describe('_normalizeConfig', function () {
    it('should copy meteor object to app', function () {
      var expected = { meteor: { path: '../' }, app: { type: 'meteor', path: '../', docker: { image: 'kadirahq/meteord', stopAppDuringPrepareBundle: true } } };
  ...
  describe('runCommand', function () {
    ...
    it('should update commandHistory', function () {
      api.runCommand('test.logs');
      (0, _chai.expect)(api.commandHistory).to.deep.equal([{ name: 'test.logs' }]);
    });
  });
